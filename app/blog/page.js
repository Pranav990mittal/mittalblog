...
const Blog = () => {
  return (
    <div className="container mx-auto p-4 text-black dark:text-black">
      {/* Main heading for the blog section */}
      <h1 className="text-4xl font-bold mb-8 text-center dark:text-white">Our Latest Blog</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 ">
        {blogs.map((blog, index) => (
          <div
            key={index}
            className="rounded-lg bg-gradient-to-r from-purple-100 to-pink-100
  shadow-md shadow-pink-200 overflow-hidden dark:border-2"
          >
            {/* Blog post image */}
            <img
              src={blog.image}
